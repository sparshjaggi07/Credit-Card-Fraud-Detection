...
df=st.cache_data(pd.read_csv)('C:/Users/spars/Downloads/creditcard.csv')
...
# Plot of feature importance using seaborn
...
if st.sidebar.checkbox('Run a credit card fraud detection model'):
    ...
    # You can add similar logic for other classifiers here (KNN, SVM, Random Forest, etc.)
